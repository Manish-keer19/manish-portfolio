...
import { manish, manish1, manish2, manish3 } from "../assets";
    ...
    <>
      ...
      <div className="flex items-center min-[1000px]:flex-row flex-col-reverse">
        ...
        >
          ...
          expertise in modern technologies like Java, JavaScript (ES6+), C++,
          Spring Boot, React, React Native, Node.js, Express.js, MongoDB, and
          SQL. I specialize in building dynamic, efficient, and user-friendly
          web and mobile applications. I've developed a real-time messenger app
          with features like OAuth2 (Google/GitHub login), JWT-based
          authentication, and media sharing using Spring Boot and MongoDB. I’ve
          also built a cross-platform desktop app using Electron.js, supporting
